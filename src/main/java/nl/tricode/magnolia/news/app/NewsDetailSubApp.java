 ...
 */
package nl.tricode.magnolia.news.app;
...
public class NewsDetailSubApp extends DetailSubApp {
    ...
    @Inject
    public NewsDetailSubApp(final SubAppContext subAppContext, final ContentSubAppView view, @Named(AdmincentralEventBus.NAME) EventBus adminCentralEventBus,
